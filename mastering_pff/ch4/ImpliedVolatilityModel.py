...
from mastering_pff.ch3.bisection import bisection
...
class ImpliedVolatilityModel(object):
    ...
    def get_implied_volatilities(self, Ks, opt_prices):
        ...
        for i in range(len(Ks)):
            ...
            # find the value of sigma thru root finding function approx function
...
if __name__ == "__main__":
    ...
    plt.savefig(IMG_PATH + 'vol_smile.png', dpi=300)
    plt.close()