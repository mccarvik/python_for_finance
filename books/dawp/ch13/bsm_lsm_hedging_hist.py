...
from dawp.ch13.bsm_lsm_hedging import *

PNG_PATH = '../png/13ch/'

def BSM_dynamic_hedge_mcs(M=50, I=1000):
...
def plot_hedge_histogram(pl_list, mod=''):
    ...
    plt.savefig(PNG_PATH + mod + 'bsm_lsm_hedge_hist.png', dpi=300)
    plt.close()
    
if __name__ == '__main__':
    pl_list = BSM_dynamic_hedge_mcs()
