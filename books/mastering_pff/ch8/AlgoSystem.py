...
class AlgoSystem:
    def __init__(self, symbol, qty, resample_interval, averaging_period=5, port=7496):
        self.client_id = 1
        self.order_id = 1
        self.qty = qty
    ...
    def tick_event(self, msg):
        if msg.field == 1:
            ...
            resampled_prices = self.last_prices.resample(self.resample_interval, how='last', fill_method="ffill")
