...
from dawp.ch13.bcc_lsm_hedging import *
from dawp.ch10.CIR_zcb_val_gen import B
from dawp.ch13.bsm_lsm_hedging_hist import plot_hedge_histogram
...
if __name__ == '__main__':
    pl_list = BCC97_hedge_simulation()
    plot_hedge_histogram(pl_list, 'bcc_')
