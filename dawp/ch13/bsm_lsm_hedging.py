...
def plot_hedge_path(S, po, vt, errs, t, mod=""):
    #
    # Graphical Output
    #
    tl = np.arange(t)
    ...
    plt.tight_layout()
    plt.savefig(PNG_PATH + mod + 'bsm_lsm_hedge.png', dpi=300)
    plt.close()
    

if __name__ == '__main__':
    results = BSM_hedge_run()
    plot_hedge_path(results[0], results[1], results[2], results[3], results[4])