...
#
kappa_v, theta_v, sigma_v, rho, v0 = np.load('../data/opt_sv.npy')
lamb, mu, delta = np.load('../data/opt_jump.npy')
...
if __name__ == '__main__':
    opt = BCC_calibration_full()
    print(BCC_calculate_model_values(opt))